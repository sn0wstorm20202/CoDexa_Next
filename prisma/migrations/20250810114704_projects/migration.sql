/*
  ...
  - You are about to drop the column `sandboxes` on the `Fragment` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "public"."Fragment" DROP COLUMN "sandboxes",
